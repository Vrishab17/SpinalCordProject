...
- Name: auth.spec.ts >> authentication smoke >> invalid credentials show an inline error
- Location: e2e/auth.spec.ts:83:7
...
Locator: getByText(/Invalid username or password/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Invalid username or password/i)
